...
![4.1 즉시 진입 화면 (로그인 없음)](wireframes-svg/01-3.1.svg)

## 4.2 생성 워크스페이스 (핵심)

![4.2 생성 워크스페이스 (핵심)](wireframes-svg/03-3.3.svg)

## 4.3 생성 진행/부분 실패 상태

![4.3 생성 진행/부분 실패 상태](wireframes-svg/07-3.7.svg)

## 4.4 결과 검토/편집 화면

![4.4 결과 검토/편집 화면](wireframes-svg/04-3.4.svg)
...
![5.1 모바일 생성 화면](wireframes-svg/08-4.1.svg)
